...
type App struct {
	...
	// Required.
	Ports map[string]*App_Port `protobuf:"bytes,5,rep,name=ports,proto3" json:"ports,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Required. Output only.
...
func (m *App) GetPorts() map[string]*App_Port {
	if m != nil {
		return m.Ports
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*App_Port)(nil), "srvc.ery.App.PortsEntry")
...
var fileDescriptor_e0f9056a14b86d47 = []byte{
	...
	,
}
